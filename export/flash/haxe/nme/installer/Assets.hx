...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceClasses.set ("assets/start.png", NME_assets_start_png);
			resourceTypes.set ("assets/start.png", "image");
			resourceClasses.set ("assets/tilesWIP.png", NME_assets_tileswip_png);
			resourceTypes.set ("assets/tilesWIP.png", "image");
