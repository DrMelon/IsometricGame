...
class ApplicationMain {
	...
	public static function getAsset (inName:String):Dynamic {
		...
		if (inName=="assets/start.png")
			 
            return Assets.getBitmapData ("assets/start.png");
         
		
		if (inName=="assets/tilesWIP.png")
			 
            return Assets.getBitmapData ("assets/tilesWIP.png");
...
class NME_assets_start_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_tileswip_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
